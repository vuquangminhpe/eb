...
const DisputeManage = () => {
  ...
  const fetchDisputes = async () => {
    setLoading(true);
    try {
      const res = await axios.get("http://localhost:9999/disputes");
  ...
  const handleStatusChange = async (id, status) => {
    try {
      ...
      const response = await axios.put(`http://localhost:9999/disputes/${id}`, {
        status,
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-2">
                        <select
                          ...
                          onChange={(e) =>
                            handleStatusChange(dispute._id, e.target.value)
                          }
                  ...
                  <td className="px-6 py-4 text-sm text-gray-500">
                    {editingId === dispute._id ? (
                      ...
                      <div className="line-clamp-2">
                        {dispute.resolution || "Chưa có phản hồi"}
                      </div>
                    )}
                  </td>
